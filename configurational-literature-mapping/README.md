...
| **ChatGPT** | 每次新对话时使用此提示词开头 | 推荐 GPT-4.5 或 5.2 |
| **Gemini** | 效果良好，需提醒遵循检查点 | 推荐 Gemini 3 Pro |
| **DeepSeek** | 在提示词前加上"请严格按照步骤执行" | 推荐 DeepSeek-V3.2 或 R1 |
| **Kimi** | 同上，适合长文本处理 | 推荐 Kimi K2.5 |
| **通义千问** | 同上 | 推荐 Qwen-Max |
